...
typedef enum
{
    ...
    FILE_reserved13 = 13, FILE_reserved14 = 14, FILE_reserved15 = 15, FILE_first_user = 16,
...
typedef struct
{
        ...
        /*  8*/
        LSN lsn; /* $LogFile sequence number for this record.
         Changed every time the record is modified. */
        /* 16*/
        u16 sequence_number; /* Number of times this mft record has been
         reused. (See description for MFT_REF
         above.) NOTE: The increment (skipping zero)
         is done when the file is deleted. NOTE: If
         this is zero it is left zero. */
        /* 18*/
        u16 link_count; /* Number of hard links, i.e. the number of
        ...
        /* 20*/
        u16 attrs_offset; /* Byte offset to the first attribute in this
         mft record from the start of the mft record.
         NOTE: Must be aligned to 8-byte boundary. */
        /* 22*/
        MFT_RECORD_FLAGS flags; /* Bit array of MFT_RECORD_FLAGS. When a file
        ...
        u32 bytes_in_use; /* Number of bytes used in this mft record.
         NOTE: Must be aligned to 8-byte boundary. */
        /* 28*/
        u32 bytes_allocated; /* Number of bytes allocated for this mft
        ...
        MFT_REF base_mft_record; /* This is zero for base mft records.
         ...
         mft record). */
        /* 40*/
        u16 next_attr_instance; /* The instance number that will be
        ...
        /* 42*/
        u16 reserved; /* Reserved/alignment. */
        /* 44*/
...
typedef struct
{
        ...
        ntfschar name[0x40]; /* Unicode name of the attribute. Zero
         terminated. */
        /* 80*/
        ATTR_TYPES type; /* Type of the attribute. */
        /* 84*/
        u32 display_rule; /* Default display rule.
         FIXME: What does it mean? (AIA) */
        /* 88*/
        COLLATION_RULES collation_rule; /* Default collation rule. */
        /* 8c*/
        ATTR_DEF_FLAGS flags; /* Flags describing the attribute. */
        /* 90*/
        s64 min_size; /* Optional minimum attribute size. */
        /* 98*/
        s64 max_size; /* Maximum size of attribute. */
...
typedef enum
{
    ATTR_IS_COMPRESSED = const_cpu_to_le16(0x0001), ATTR_COMPRESSION_MASK = const_cpu_to_le16(0x00ff), /* Compression
     method mask. Also, first
     illegal value. */
    ATTR_IS_ENCRYPTED = const_cpu_to_le16(0x4000), ATTR_IS_SPARSE = const_cpu_to_le16(0x8000),
...
typedef struct
{
        ...
        /*  4*/
        u32 length; /* Byte size of the resident part of the
         attribute (aligned to 8-byte boundary).
         Used to get to the next attribute. */
        /*  8*/
        u8 non_resident; /* If 0, attribute is resident.
         If 1, attribute is non-resident. */
        /*  9*/
        u8 name_length; /* Unicode character size of name of attribute.
         0 if unnamed. */
        /* 10*/
        u16 name_offset; /* If name_length != 0, the byte offset to the
         ...
         boundary. */
        /* 12*/
        ATTR_FLAGS flags; /* Flags describing the attribute. */
        /* 14*/
        u16 instance; /* The instance of this attribute record. This
        ...
        union
        {
                ...
                struct
                {
                        ...
                        /* 23 */
                        s8 reservedR; /* Reserved/alignment to 8-byte
                         boundary. */
                        /* 24 */
                ...
                struct
                {
                        ...
                        /* 35*/
                        u8 reserved1[5]; /* Align to 8-byte boundary. */
                        /* The sizes below are only used when lowest_vcn is zero, as otherwise it would
                         be difficult to keep them up-to-date.*/
                        /* 40*/
                        s64 allocated_size; /* Byte size of disk space
                        ...
                        /* 48*/
                        s64 data_size; /* Byte size of the attribute
                         value. Can be larger than allocated_size if
                         attribute value is compressed or sparse. */
                        /* 56*/
                        s64 initialized_size; /* Byte size of initialized
                        ...
                        /* 64*/
                        s64 compressed_size; /* Byte size of the attribute
...
typedef struct
{
        ...
        /*  8*/
        s64 last_data_change_time; /* Time the data attribute was last
         modified. */
        /* 16*/
        s64 last_mft_change_time; /* Time this mft record was last
         modified. */
        /* 24*/
        s64 last_access_time; /* Approximate time when the file was
        ...
        union
        {
                ...
                struct
                {
                        ...
                        u8 reserved12[12]; /* Reserved/alignment to 8-byte
                         boundary. */
                        /* 48 */
                        void *v1_end[0]; /* Marker for offsetof(). */
                }__attribute__((__packed__));
                /* sizeof() = 48 bytes */
                /* NTFS 3.0 */
                struct
                {
                        ...
                        /* 40*/
                        u32 version_number; /* This file's version (if any).
                         Set to zero if maximum_versions is zero. */
                        /* 44*/
                        u32 class_id; /* Class id from bidirectional
                         class id index (?). */
                        /* 48*/
                        u32 owner_id; /* Owner_id of the user owning
                         the file. Translate via $Q index in FILE_Extend
                         /$Quota to the quota control entry for the user
                         owning the file. Zero if quotas are disabled. */
                        /* 52*/
                        u32 security_id; /* Security_id for the file.
                         Translate via $SII index and $SDS data stream
                         in FILE_Secure to the security descriptor. */
                        /* 56*/
                        u64 quota_charged; /* Byte size of the charge to
                         the quota for all streams of the file. Note: Is
                         zero if quotas are disabled. */
                        /* 64*/
                        u64 usn; /* Last update sequence number
                        ...
                        /* 72*/
                        void *v3_end[0]; /* Marker for offsetof(). */
                }__attribute__((__packed__));
        }__attribute__((__packed__));
...
typedef struct
{
        ...
        /*  4*/
        u16 length; /* Byte size of this entry. */
        /*  6*/
        u8 name_length; /* Size in Unicode chars of the name of the
         attribute or 0 if unnamed. */
        /*  7*/
        u8 name_offset; /* Byte offset to beginning of attribute name
         (always set this to where the name would
         start even if unnamed). */
        /*  8*/
        VCN lowest_vcn; /* Lowest virtual cluster number of this portion
         ...
         as signed. */
        /* 16*/
        MFT_REF mft_reference; /* The reference of the mft record holding
         the ATTR_RECORD for this portion of the
         attribute value. */
        /* 24*/
        u16 instance; /* If lowest_vcn = 0, the instance of the
         attribute being referenced; otherwise 0. */
        /* 26*/
        ntfschar name[0]; /* Use when creating only. When reading use
...
typedef struct
{
        ...
        MFT_REF parent_directory; /* Directory this filename is
         referenced from. */
        /*  8*/
        s64 creation_time; /* Time file was created. */
        /* 10*/
        s64 last_data_change_time; /* Time the data attribute was last
         modified. */
        /* 18*/
        s64 last_mft_change_time; /* Time this mft record was last
         modified. */
        /* 20*/
        s64 last_access_time; /* Last time this mft record was
         accessed. */
        /* 28*/
        s64 allocated_size; /* Byte size of on-disk allocated space
        ...
        /* 30*/
        s64 data_size; /* Byte size of actual data in data
         attribute. */
        /* 38*/
        FILE_ATTR_FLAGS file_attributes; /* Flags describing the file. */
        /* 3c*/
        union
        {
                ...
                /* 3c*/
                u32 reparse_point_tag; /* Type of reparse point,
                 present only in reparse
                 points and only if there are
                 no EAs. */
        }__attribute__((__packed__));
        /* 40*/
        u8 file_name_length; /* Length of file name in
         (Unicode) characters. */
        /* 41*/
        FILE_NAME_TYPE_FLAGS file_name_type; /* Namespace of the file name.*/
        /* 42*/
        ntfschar file_name[0]; /* File name in Unicode. */
...
typedef enum
{
    ACE_OBJECT_TYPE_PRESENT = const_cpu_to_le32(1), ACE_INHERITED_OBJECT_TYPE_PRESENT = const_cpu_to_le32(2),
} OBJECT_ACE_FLAGS;
...
typedef struct
{
        ...
        ACCESS_MASK mask; /* Access mask associated with the ACE. */
        /*  8*/
        OBJECT_ACE_FLAGS object_flags; /* Flags describing the object ACE. */
        /* 12*/
        GUID object_type;
        /* 28*/
        ...
        /* 44*/
        SID sid; /* The SID associated with the ACE. */
}__attribute__((__packed__)) ACCESS_ALLOWED_OBJECT_ACE, ACCESS_DENIED_OBJECT_ACE, SYSTEM_AUDIT_OBJECT_ACE,
...
{
    /* Current revision. */
    SECURITY_DESCRIPTOR_REVISION = 1, SECURITY_DESCRIPTOR_REVISION1 = 1,
...
typedef struct
{
        ...
        /*  4*/
        u32 index_length; /* Data size in byte of the INDEX_ENTRY's,
         including the INDEX_HEADER, aligned to 8. */
        /*  8*/
        u32 allocated_size; /* Allocated byte size of this index (block),
         ...
         */
        /* 12*/
        INDEX_HEADER_FLAGS ih_flags; /* Bit field of INDEX_HEADER_FLAGS.  */
        /* 13*/
...
typedef struct
{
        ...
        /*  8*/
        u32 index_block_size; /* Size of index block in bytes (in
         the index allocation attribute). */
        /* 12*/
        s8 clusters_per_index_block; /* Size of index block in clusters (in
...
typedef struct
{
        ...
        /*  8*/
        LSN lsn; /* $LogFile sequence number of the last
...
typedef struct
{
        ...
        u16 key_length; /* Byte size of the key value, which is in the
         ...
         multiple of 8-bytes. */
        /* 12*/
        INDEX_ENTRY_FLAGS ie_flags; /* Bit field of INDEX_ENTRY_* flags. */
        /* 14*/
...
typedef struct
{
        ...
        /* 16*/
        u8 unknown4[16]; /* MD5 hash of decrypted FEK?  This field is
        ...
        /* 32*/
        u8 unknown5[16]; /* MD5 hash of DDFs? */
        /* 48*/
        u8 unknown6[16]; /* MD5 hash of DRFs? */
        /* 64*/
        u32 offset_to_ddf_array;/* Offset in bytes to the array of data
...
typedef struct
{
        ...
        /* 16*/
        u32 unknown1; /* always 0?  Might be just padding. */
...
typedef struct
{
        ...
        u32 sid_offset; /* Offset in bytes to the user's sid from start
         ...
         present. */
        /*  8*/
        u32 type; /* Type of this credential:
        ...
        union
        {
                ...
                struct
                {
                        ...
                        /* 16*/
                        u32 provider_name_offset; /* Offset in bytes to
                        ...
                        u32 public_key_blob_offset; /* Offset in bytes to
                         ...
                         structure. */
                        /* 24*/
                        u32 public_key_blob_size; /* Size in bytes of
                         public key blob. */
                }__attribute__((__packed__));
                ...
                struct
                {
                        ...
                        u32 cert_thumbprint_header_size; /* Size in
                         ...
                         thumbprint. */
                        /* 16*/
                        u32 cert_thumbprint_header_offset; /* Offset in
...
typedef struct
{
        ...
        u32 provider_name_offset; /* Offset in bytes to the name of the
         ...
         present. */
        /* 16*/
        u32 user_name_offset; /* Offset in bytes to the user name
